...
export function EditCategoryPage() {
  ...
  const { form, onSubmit, handleCancel, isLoading, isDataLoading, error } = useEditCategoryPage()
  ...
  return (
    <Card title={t('categories.edit.title')} className="py-6 min-h-0" contentClassName="p-0 px-6">
      <Form {...form}>
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      id="name"
                      type="text"
                      placeholder={t('categories.list.table.column_name')}
                      disabled={isLoading}
                      {...field}
                    />
                  </FormControl>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      id="description"
                      placeholder={t('categories.list.table.column_description')}
                      disabled={isLoading}
                      {...field}
                    />
                  </FormControl>
