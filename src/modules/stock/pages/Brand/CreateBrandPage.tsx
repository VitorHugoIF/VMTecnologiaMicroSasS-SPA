...
import { useCreateBrandPage } from './hooks/useCreateBrandPage'
...
export function CreateBrandPage() {
  ...
  const { form, isLoading, onSubmit, error } = useCreateBrandPage()

  return (
    <Card title={t('brands.list.add')} className="py-6 min-h-0" contentClassName="p-0 px-6">
      <Form {...form}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input id="name" placeholder={t('brands.list.table.column_name')} {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea id="description" placeholder={t('brands.list.table.column_description')} {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
