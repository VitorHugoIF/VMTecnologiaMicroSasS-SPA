...
export type ToastContent = ReactNode | { title?: ReactNode; description?: ReactNode }
...
function handleToast(
  ...
  if (
    ...
    content !== null &&
    (('title' in content && content.title !== undefined) ||
...
export const Toast = {
  success: (content: ToastContent, options?: ToastOptions) =>
    handleToast(sonnerToast.success, content, options ?? {}, 'Success'),
  error: (content: ToastContent, options?: ToastOptions) =>
    handleToast(sonnerToast.error, content, options ?? {}, 'Error'),
  warning: (content: ToastContent, options?: ToastOptions) =>
    handleToast(sonnerToast.warning, content, options ?? {}, 'Warning'),
  info: (content: ToastContent, options?: ToastOptions) =>
    handleToast(sonnerToast.info, content, options ?? {}, 'Info'),
}
