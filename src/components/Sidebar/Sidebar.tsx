    ...
    <>
      ...
      >
        <SidebarHeader className={`flex flex-col 
            ...
            <img src={logo} alt="Logo" className={`h-10 w-auto max-w-[80%] object-contain ${open ? 'self-start' : ''}`} />
        </SidebarHeader>
        ...
        <SidebarFooter className={`flex items-center justify-center w-full h-16 mt-auto border-none`}>
